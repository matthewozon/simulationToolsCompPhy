#include "PP_el_hahn.h"

PP_el_hahn::PP_el_hahn()
{
}

void PP_el_hahn::monochromatic(double mx0, double my0, double mz0, double dw, bool rotFrame)
{
...
void PP_el_hahn::biChromatic(double mx0, double my0, double mz0, double dw, bool rotFrame)
{
...
void PP_el_hahn::multiChrome(double mx0, double my0, double mz0, int N, bool rotFrame)
{
    C_matrix<double> MUsteady1;
    C_matrix<double> MUfisrtPulse1;
    C_matrix<double> MUfirstFID1;
