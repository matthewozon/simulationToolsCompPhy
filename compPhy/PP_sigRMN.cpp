...
void PP_sigRMN::frameToFix(double t00)//TODO fix the continuity pb due to frame change
{
    double tmpX, tmpY;
...
void PP_sigRMN::frameToRotating(double t00)
{
    double tmpX, tmpY;
    for(int i=0 ; i<MU.getNbRow() ; i++)
    {
...
double PP_sigRMN::generateRMNsignal(double mx0, double my0, double mz0, double dt, double dw)
{
    //init the arrays
...
double PP_sigRMN::generateFIDsignal(double mx0, double my0, double mz0, double dt, double dw)
{
    //init the arrays
    MU.resize(sigLength,3);
    T.resize(sigLength,1);
...
double PP_sigRMN::generateFIDsignalWithDiffusion(double mx0, double my0, double mz0, double dt, double dw)
{
    //init the arrays
    MU.resize(sigLength,3);
    T.resize(sigLength,1);
